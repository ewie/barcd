...
ebenfalls eine gute Annäherung bietet \cite[Kap.~5.2]{davies2012}.

\subsection*{Roberts-Operator}
Der Ursprung des \surname{Roberts}-Operators \cite[S.~26]{DBLP:books/garland/Roberts63} ist die Kantenerkennung in technischen Strichzeichnungen.
...
Der \surname{Sobel}-Operator \cite[Kap.~5.2]{davies2012} unterscheidet sich kaum vom \surname{Prewitt}-Operator.
...
Der \surname{Scharr}-Operator \cite[Kap.~9.3]{scharr2000} ist eine Weiterentwicklung des surname{Sobel}-Operators mit besserer Rotationssymmetrie.
Erfasst Bildrauschen jedoch noch stärker als der \surname{Sobel}-Operator.
  \[ K_X = \begin{vmatrix}
        -3 & 0 &  3 \\
       -10 & 0 & 10 \\
        -3 & 0 &  3
