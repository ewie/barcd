 ...
 *         &lt;element name="point" type="{http://www.tu-chemnitz.de/informatik/mi/barcd}PointType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PointsElement {
    ...
    protected List<PointElement> point;
     ...
     * 
     */
    public List<PointElement> getPoint() {
        if (point == null) {
            point = new ArrayList<PointElement>();
        }
        return this.point;
    }
