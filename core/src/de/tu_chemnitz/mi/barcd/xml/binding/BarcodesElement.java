 ...
 *         &lt;element name="barcode" type="{http://www.tu-chemnitz.de/informatik/mi/barcd}BarcodeType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class BarcodesElement {

    @XmlElement(required = true)
    protected List<BarcodeElement> barcode;
     ...
     * 
     */
    public List<BarcodeElement> getBarcode() {
        if (barcode == null) {
            barcode = new ArrayList<BarcodeElement>();
        }
        return this.barcode;
    }
